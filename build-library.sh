...
cd src
javac -classpath "../lib/processing-core-0186.jar;../lib/piccolo2d-core-2.0-SNAPSHOT.jar;../lib/piccolo2d-jdk16-2.0-SNAPSHOT.jar" org/piccolo2d/processing/Piccolo2D.java
